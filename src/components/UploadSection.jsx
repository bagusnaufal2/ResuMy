    ...
    return (
        <section className="upload-section" id="upload-cv">
            <div className="section-heading">
                ...
                <h2 className="upload-title">Upload your resume and get a match report</h2>
            ...
            <div className="tech-strip" id="tech">
                <p className="tech-strip-label">Powered by modern tech</p>
                <p className="tech-strip-description">
                    ResuMy is built with a reliable stack to deliver fast resume analysis,
                    smooth interactions, and scalable data processing for every upload.
                </p>
                <div className="tech-logos">
                    {techList.map((tech) => (
                        <div className="tech-logo-item" key={tech.label} aria-label={tech.label} title={tech.label}>
                            <span className="tech-logo-icon">{tech.icon}</span>
                            <div className="tech-logo-copy">
                                <span className="tech-logo-text">{tech.label}</span>
                                <span className="tech-logo-description">{tech.description}</span>
                            </div>
                        </div>
                    ))}
                </div>
